...
class GetMintByTransfer(
    ...
    override suspend fun doExecute(context: IWeb3Context): Mint {
        ...
        val tx = ethereumSource.getTx(transfer.transactionHash)!!
        ...
        val collection = attrs.getOrNull(2) as? Collection
        return Mint(
